...
1. `git branch -m "new_branch_name"`  - перейменовує поточну гілку.
1. `git cherry-pick <commit>` - додає в поточну гілку зміни, внесені конкретним комітом з іншої гілки.
